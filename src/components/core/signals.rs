use crate::components::core::types::{ObjectiveFunction, OptimizerState};
use leptos::prelude::*;

/// Centralized state for the CMA-ES optimizer
#[derive(Clone, Copy)]
pub struct OptimizerStateSignals {
    pub objective_fn: RwSignal<ObjectiveFunction>,
...
impl OptimizerStateSignals {
    pub fn new() -> Self {
        Self {
            objective_fn: RwSignal::new(ObjectiveFunction::Sphere),
